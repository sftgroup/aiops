...
export function registerTools(server, baseUrl, apiKey) {
    server.tool("generate_content", "使用 AIOps 生成社交媒体文案。支持多种平台和风格。", {
    ...
    server.tool("synthesize_tts", "使用 AIOps 进行文本转语音合成，生成 MP3 音频。", {
    ...
    server.tool("list_tts_voices", "查询 AIOps 可用的语音合成角色列表。", {
    ...
    server.tool("check_quota", "查询当前账户的 AIOps 配额使用情况，包括内容生成、TTS、视频的用量和上限。", {}, async () => {
